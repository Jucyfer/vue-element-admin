// Just a mock data
// 这个只是给mock用的，实际是/src/router/index.js在实际控制
// 如果在dev环境修改，控制台只会提示 Mock Server hot reload success!
// 已知涉及：角色及用户管理时，会mock出这里的数据
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'allreports',
        component: 'views/usr_tables/usr_all-reports_admin',
        name: 'AllReports',
